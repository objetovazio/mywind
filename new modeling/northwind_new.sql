...
CREATE TABLE IF NOT EXISTS `northwind_new`.`date_dimension` (
  `date_key` MEDIUMINT(8) NOT NULL COMMENT '\n',
  `date` DATE NULL,
  `day_of_week` SMALLINT(1) NULL,
  `dat_of_month` SMALLINT(2) NULL,
...
CREATE TABLE IF NOT EXISTS `northwind_new`.`orders` (
  ...
  `order_date` MEDIUMINT(8) NULL,
  `shipped_date` MEDIUMINT(8) NULL,
